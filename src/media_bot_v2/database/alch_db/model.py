...
from media_bot_v2.app_enums import UserOptions, MediaType, LockingStatus, TorrentType
...
def create_db(connection_str, db_name):
    ...
    with enj.connect() as connection:
        connection.execute('CREATE DATABASE {} CHARACTER SET utf8 COLLATE utf8_general_ci'.format(db_name))
